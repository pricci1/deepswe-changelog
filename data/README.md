...
Source: https://deepswe.datacurve.ai/artifacts
Upstream generated at: 2026-05-20T19:36:27.671905+00:00
...
| Model | DeepSWE | SWE-Bench Pro | Source |
| --- | --- | --- | --- |
| gpt-5-5 | 70.0% | 58.6% | https://openai.com/index/introducing-gpt-5-5/ |
| claude-opus-4-7 | 54.2% | 64.3% | https://www.anthropic.com/news/claude-opus-4-7 |
| gpt-5-4 | 55.5% | 57.7% | https://openai.com/index/introducing-gpt-5-5/ |
| claude-sonnet-4-6 | 32.0% | 54.4% | https://labs.scale.com/leaderboard/swe_bench_pro_public |
| gpt-5-4-mini | 24.3% | 54.4% | https://openai.com/index/introducing-gpt-5-4-mini-and-nano/ |
| gemini-3-1-pro-preview | 9.9% | 46.1% | https://labs.scale.com/leaderboard/swe_bench_pro_public |
| gemini-3-flash-preview | 5.2% | 34.6% | https://labs.scale.com/leaderboard/swe_bench_pro_public |
| claude-haiku-4-5 | 0.2% | 39.5% | https://labs.scale.com/leaderboard/swe_bench_pro_public |
...
| Repository | Language | Stars | Tasks | Files |
| --- | --- | --- | --- | --- |
| pmndrs/koota | TypeScript | 684 | 5 | 475 |
| encode/httpx | Python | 15,262 | 3 | 125 |
| PyCQA/bandit | Python | 8,021 | 3 | 298 |
| platers/obsidian-linter | TypeScript | 1,920 | 3 | 320 |
| fastapi/fastapi | Python | 98,127 | 2 | 2,988 |
| prometheus/prometheus | TypeScript | 64,002 | 2 | 1,611 |
| Textualize/textual | Python | 35,856 | 2 | 2,117 |
| helm/helm | Go | 29,802 | 2 | 1,995 |
| open-policy-agent/opa | Go | 11,712 | 2 | 7,468 |
| capricorn86/happy-dom | TypeScript | 4,471 | 2 | 1,046 |
| d5/tengo | Go | 3,804 | 2 | 119 |
| celery/kombu | Python | 3,111 | 2 | 343 |
| testem/testem | JavaScript | 2,919 | 2 | 485 |
| dynamodb-toolbox/dynamodb-toolbox | TypeScript | 1,998 | 2 | 914 |
| mattn/anko | Go | 1,564 | 2 | 142 |
| abs-lang/abs | Go | 610 | 2 | 326 |
| langchain-ai/langchain | Python | 136,553 | 1 | 2,882 |
| TanStack/query | TypeScript | 49,402 | 1 | 2,343 |
| slab/quill | TypeScript | 47,103 | 1 | 377 |
| sharkdp/fd | Rust | 42,943 | 1 | 57 |
